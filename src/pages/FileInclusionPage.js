...
const FileInclusionPage = () => {
  ...
  // to only allow the name of the wanted file. other than that
  // we will bloc the content and the nothing will be printed.
  useEffect(() => {
    const div = document.getElementById("inclusionFileSection");
    ...
    <div>
      <div className={styles.card}>
        ...
        <div className={styles.desc}>
          To include a file edit the ?page=index.php in the URL to determine
